...
export default function FeatureSection(){
  ...
  const muxPlaybackIds = [
    'V674GRrZGdZ4prda59b2kTEryiCS5GMcPa7I18Lpm02E',  // Chat
    'lZf3016qjDr6KyXF6us818F41C7yoONQ02LdVYu8tQ8t00',  // Content management
    'lW01ZLiPdXPsFDc1QZhc6DsVq6keEUNdHrkdKpourK5Y',  // Post editor
    'hERfetNtq8e8tnQtbSrPG02UQtPMcRQn00DeLthzJFFlY',  // progress
    'Qz01hd02anGtuwj6Reprx59t00IEQMmoBU68rar1W96bw8',  // Knowledge base
  ];
          ...
          <div className="grid md:grid-cols-12 gap-8 min-h-[600px] items-center">
            ...
            <div className="md:col-span-8 flex items-center justify-center self-center">
              <div className="w-full max-w-4xl aspect-video rounded-2xl overflow-hidden shadow-xl">
                <MuxPlayer
                  key={activeFeature}
                  playbackId={muxPlaybackIds[activeFeature]}
                  style={{height: '100%', width: '100%'}}
                  metadata={{
                    video_id: `feature-video-${activeFeature}`,
